      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container mx-auto px-4 py-8">
          <header className="flex justify-between items-baseline mb-8 w-fit">
            <h1 className="text-3xl font-bold text-gray-800">EduChain{": "}</h1>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <li className="bg-gray-100 p-4 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    ...
                    personalized learning paths with curated content tailored to
                    individual needs.
                  </p>
                </li>
                <li className="bg-gray-100 p-4 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    ...
                    leverage gamification elements to boost engagement. Modules
                    may include quizzes, interactive exercises, and simulations
                    that provide immediate feedback and track progress.
                  </p>
                </li>
                <li className="bg-gray-100 p-4 rounded-lg shadow-md">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">
                  ...
                  <p className="text-gray-600">
                    ...
                    blockchain ledger. This ensures data security, transparency,
                ...
                <li className="bg-gray-100 p-4 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    ...
                    verification method (e.g., facial recognition, unique access
                    codes).
                  </p>
                </li>
                <li className="bg-gray-100 p-4 rounded-lg shadow-md">
